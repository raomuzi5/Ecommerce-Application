...
export class ProductDashboardComponent implements OnInit {
  ...
  public topfiveproduct: EChartOption = {};
  ...
  public dataMap:any = {};
  public testOption: EChartOption;
  ...
  constructor() {
    ...
    this.topfiveproduct = {
      ...
      radiusAxis: {
          type: 'category',
          data: ['TV', 'Sunglass', 'Clock', 'Lamp','Bag'],
          z: 10,
          axisLabel:{
            color:'#757575'
          },
  ...
  ngOnInit() {
    ...
    this.chartOptions = {
      ...
      legend: {
          data: ['India', 'Uk', 'South Korea', 'Spain', 'Russia'],
          textStyle:{
              color: "#C2C2C2"
          }
      },
